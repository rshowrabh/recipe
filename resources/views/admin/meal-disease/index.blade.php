    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <a href="{{ url('/admin/meal-disease/create') }}" class="btn btn-primary float-right">
            ...
            <div class="card-body">
                @include('layout.flash_message')
                  <table id="example" class="table table-bordered table-striped">
                      <thead>
                          <tr>
                              <th>Name</th><th>Symptoms</th><th>Food To Eaten</th><th>Food To Avoid</th><th>Status</th><th>Actions</th>
                           </tr>
                       </thead>
                      <tbody>
                                                 @foreach($mealdisease as $item)
                                                     <tr>
